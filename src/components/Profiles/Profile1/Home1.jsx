...
function Home1() {
  ...
  useEffect(() => {
    axios
      .get('https://mernback1-n2ty.onrender.com/profile1')
  ...
  const handleDelete = (id) => {
    axios
    .delete(`https://mernback1-n2ty.onrender.com/profile1/delete/${id}`)
    .then((res) => {
      console.log(res);
  ...
  const handleCheckboxChange = (foodId) => {
    ...
    if (!isSelected) {
      ...
      axios.post('https://mernback1-n2ty.onrender.com/profile1/saveSelectedFood', selectedFoodDetails)
        .then((res) => {
      ...
      if (storedObjectId) {
        axios.delete(`https://mernback1-n2ty.onrender.com/profile1/deleteSelectedFood/${storedObjectId}`)
          .then((res) => {
  ...
  const handleClearTable = () => {
    axios.delete('https://mernback1-n2ty.onrender.com/profile1/clearTable')
      .then((res) => {
...
<div className="d-flex vh-100 bg-primary justify-content-center align-items-center">
  ...
  <div className="w-75 bg-white rounded p-3">
    <div className="d-flex justify-content-between mb-3">
      <Link to="/profile1/create" className="btn btn-success">
        Add+
      </Link>

      <Link to="/profile1/order" className="btn btn-success">
        Order
      </Link>
          ...
          <tbody>
            {foods.map((food) => (
              <tr key={food._id}>
                ...
                <td>{food.price}</td>
                <td>
                  <Link to={`/profile1/update/${food._id}`} className="btn btn-success">
                    Update
                  </Link>
                  <button
